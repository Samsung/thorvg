...
enum class TVG_EXPORT CompositeMethod
{
    ...
    ColorMask     ///< The source pixels are converted to the grayscale and alpha blended with the target. As a result, only the part of the source, which intersects with the target is visible.
};
